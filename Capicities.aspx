<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Capicities.aspx.cs" Inherits="Capicities" %>
    ...
    <div class="main">
        ...
        <div class="container-fluid" >
            ...
            <div class="row">
             ...
             <div class="row">
                <div class="col-lg-12" style=" font-size:25px; text-align:center; margin-top:30px; font-family:'Segoe Print'; color:rgba(255,255,255,0.9);"> THIS ARE OUR CAPACITIES <br /> Contact IT </div>

            </div>
             
           <asp:DataList ID="DataList1" runat="server" CellPadding="8" RepeatColumns="3"  RepeatDirection="Vertical" ForeColor="white"  Height="228px"  BackColor="Transparent" BorderColor="Transparent"  GridLines="Both" AlternatingItemStyle-Wrap="True" CssClass="jh">
                            ...
                            <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White"    />
                                    ...
                                    <ItemTemplate >
                                         <table class="table" style="padding:20px; margin:20px;">
                                               ...
                                               <td> <asp:Image ID="Image1" ImageUrl='<%# Eval("Image") %>' runat="server" />      
                                               </td> 
                                             </tr>
                <tr>  
                    <th>
