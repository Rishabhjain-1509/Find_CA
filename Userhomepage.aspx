...
<head runat="server">
    <title>User Home Web Page</title>
    <meta content="utf-8"/>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid" >
                    ...
                    <div class="navbar navbar-default"> 
                        <div class="container-fluid">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="usercontact.aspx"Contact.aspx">CONTACT</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12" style="font-family:Segoe Print;  color:rgba(255,255,225,0.9); margin-top:15%; font-size:50px;  text-align:center; height:351px;"><P style=" font-size:20px;">WELLCOME</P> <P style="font-size:40px;">CHARTERED ACCOUNTANT</P> <p style="font-size:20px;"> IN </P> <p style="font-size:30px;">ACAFH</p>  </div>
                </div>
            </div>
