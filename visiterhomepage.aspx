<%@ Page Language="C#" AutoEventWireup="true" CodeFile="visiterhomepage.aspx.cs" Inherits="visiterhomepage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid" font-size="18px">
                    ...
                    <div class="navbar navbar-default"> 
                        <div class="container-fluid">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="Visiterworks.aspx">BATCH</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12" style="font-family:Segoe Print;  color:rgba(255,255,225,0.9); margin-top:15%; font-size:50px;  text-align:center; height:359px;"><asp:Label ID="lbusershow"  runat="server" Font-Size="16px"></asp:Label><P style=" font-size:20px;">BEST</P> <P style="font-size:40px;">CHARTERED ACCOUNTANT</P> <p style="font-size:20px;"> ARE FIND HERE</P>  </div>
                </div>
            </div>
