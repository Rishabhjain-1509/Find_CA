                    ...
                    <nav class="navbar navbar-default" style="border:none; background-color:rgba(0,0,0,0.0); height:90px; width:100%;"> 
                        <div class="container-fluid">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li style="font-family:Segoe Print;"><a href="Userhomepage.aspx">HOME</a></li>
                                <li style="font-family:Segoe Print;"><a href="Capicities.aspx">CAPICITIES</a></li>
                                <li style="font-family:Segoe Print;"><a href="Userworks.aspx">WORKS</a></li>
                                <li style="font-family:Segoe Print;"><a href="about.aspx">ABOUT</a></li>
                                <li style="font-family:Segoe Print;"><a href="usercontact.aspx">CONTACT</a></li>
                ...
                <div class="row"  style=" height:351px;">
                    ...
                    <div class="col-lg-3">
                        <table>
                            ...
                            <tr>
                                <td style=" height:100px;"> <asp:Button ID="Button2" runat="server" Text="VIEW ON MAP" Height="40px" Width="200px" BackColor="#333333" BorderStyle="None" ForeColor="#CCCCCC" Font-Size="14px" /></td>
                            </tr>
                            <tr>
                        ...
                        <table>
                            ...
                            <tr>
                                <td style=" height:100px;">
                                      <asp:Button ID="Button3" runat="server" Text="VIEW ON MAP" Height="40px" Width="200px" BackColor="#333333" BorderStyle="None" ForeColor="#CCCCCC" Font-Size="14px" /></td>
                            </tr>
                        </table>
                    </div>
